...
class Yc7Device : public MB_DDF::PhysicalLayer::Device::TransportLinkAdapter {
public:
    // DMA 通道与事件均按 0 配置；MTU 可由上层配置传入
    explicit Yc7Device(MB_DDF::PhysicalLayer::ControlPlane::IDeviceTransport& tp, uint16_t mtu)
